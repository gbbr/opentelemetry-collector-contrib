...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/datadogstatsprocessor v0.54.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/processor/datadogstatsprocessor => ./processor/datadogstatsprocessor
